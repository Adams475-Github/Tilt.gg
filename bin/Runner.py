...
summonerUtils = SummonerQueryUtils.SummonerQueryUtils("NA1", "HULKSMASH1337")
recent_match = summonerUtils.get_latest_match()
gameData = PlayerGameData.PlayerGameData(recent_match, summonerUtils.summoner_name)
print(gameData)
